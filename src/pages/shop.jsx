  ...
  return (
    <Shop>
      ...
      <Shop.Container>
        <Shop.Navigation>
          <Shop.NavigationBtn
            onClick={() => dispatch(setCurrentShop(allItems))}
          >
            All
          </Shop.NavigationBtn>
          <Shop.NavigationBtn
            onClick={() => dispatch(filterShopCategory("hat"))}
          >
            Hats
          </Shop.NavigationBtn>
          <Shop.NavigationBtn
            onClick={() => dispatch(filterShopCategory("jackets"))}
          >
            Jackets
          </Shop.NavigationBtn>
          <Shop.NavigationBtn
            onClick={() => dispatch(filterShopCategory("shoes"))}
          >
            Shoes
          </Shop.NavigationBtn>
          <Shop.NavigationBtn
            onClick={() => dispatch(filterShopCategory("shirt"))}
          >
            Shirts
          </Shop.NavigationBtn>
          <Shop.NavigationBtn
            onClick={() => dispatch(filterShopCategory("bag"))}
          >
            Bags
          </Shop.NavigationBtn>
        </Shop.Navigation>
